...
jQuery.extend( Control, {
    ...
    /*
     * An element has been added to the document; see if it's a control that's
     ...
     * We use DOMNodeInserted on the body instead of DOMNodeInsertedIntoDocument;
     * as of 7/2011, the former has better browser coverage.
     */    
    _startListeningForElementInsertion: function() {
        jQuery( "body" ).bind( "DOMNodeInserted", Control._documentNodeInserted );
        Control._listeningForElementInsertion = true;
    },
    
    _stopListeningForElementInsertion: function() {
        jQuery( "body" ).unbind( "DOMNodeInserted", Control._documentNodeInserted );
