...
$.extend( Control, {
    ...
    subclass: function( json ) {
        ...
        if ( json ) {
            ...
            var cleanJson = copyExcludingKeys( json, {
                className: true,
                prototype: true,
                tag: true
            });
 ...
 * For speed, the keys should be provided as a dictionary. E.g., the dictionary
 * { a: true, b: true } will specify that keys "a" and "b" should be removed.
 */
...
function controlFromJson( json, logicalParent ) {
    ...
    var isControl = ( firstKey === "control" );
    var isHtml = ( firstKey === "html" );
    ...
    control.json( properties, logicalParent );
...
$.extend( Control.prototype, {
     ...
     * 
     * logicalParent is a parameter for internal use.
     */
