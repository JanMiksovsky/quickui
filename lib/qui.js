...
QuickControl = Class.extend({
	...
	content: function(value) {
		var result = $(this.element).setContents(value);
		if (value !== undefined && result != null && $.isArray(result))
		{
			// Instead of returning array with one element, return the singleton itself.
			result = result[0];
		}
		return result;
	},
 ...
 */
jQuery.fn.setContents = function(value) {
	if (value !== undefined)
	{
		// Setting contents.
		this.empty();
