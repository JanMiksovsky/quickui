...
Because we're subclassing using CoffeeScript, we'll have to fix up this class
later with a call to makeJQueryCompatible.
###
class window.Control extends jQuery
